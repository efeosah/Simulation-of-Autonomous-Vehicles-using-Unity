...
public class CarController : MonoBehaviour, ICar
{
    ...
    private Vector3 m_Prevpos, m_Pos, startPos;
    ...
    public float MaxSteer { get { return m_MaximumSteerAngle; } }
    public Vector3 StartPosition { get { return startPos; } }
    public Quaternion StartRotation { get { return startRot; } }
    public String Type { get { return m_SpeedType == 0 ? " MPH" : " KPH"; } }
