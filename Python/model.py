...
###Model is based on the Nvidia end-to-end deep learning paper
###More info can be found @ https://images.nvidia.com/content/tegra/automotive/images/2016/solutions/pdf/end-to-end-dl-using-px.pdf
